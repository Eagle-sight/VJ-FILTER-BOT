...
API_HASH = environ.get('API_HASH', '6fda5ca7b274656fa86fa64663eb2586')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002196561169'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7126250699 1744264999').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002164551434').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://rudra:rudra@cluster0.0q1dw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://contemporary-cynthea-technicalhub-b97479aa.koyeb.app/")
